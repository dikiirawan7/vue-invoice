<template>
    <div class="container pt-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-striped table-bordered ">
                            ...
                            <tbody v-for="(customer,nomer) in dataCustomer" :key="customer.id">
                                <tr>
                                    <td>{{nomer+1}}</td>
                                    <td>{{customer.nama}}</td>
        ...
        <AddCustomer ref="modal" :aksi="aksi" v-on:Simpan="CloseCustomer()"></AddCustomer>
    </div>
</template>
...
export default {
    ...
    methods:{
       ...
       CloseCustomer(){
        ...
        fetchUsers(page=1){
            ...
            showModal(id) {
                ...
                if(!id){
                    ...
                    this.aksi.klik="Ubah";
                    let uri= `http://localhost:8000/api/customer/find/${id}`;
        ...
        deleteCustomer(id,no){

            let uri = `http://localhost:8000/api/customer/delete/${id}`;
                ...
                confirmButtonText: 'Yes, delete it!'
                    ...
                    if (result.value) {
                        axios.delete(uri).then(response=>{
                            ...
                            this.$swal.fire(
                                'Deleted!',
                                'Customer '+nama+' Berhasil Dihapus.',
                                'success'
                                ).then(response=>{
                                    this.fetchUsers(this.meta_data.current_page);
